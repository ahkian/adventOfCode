...
var realInput = parseIntoStr(innerText)
function dayOne(arr) {
  let currVal = 0
  let freqObj = {}
  let repeat = false
...
console.log("My solution", dayOnePartTwo(realInput), 'Billys solution', dayOne(realInput))
